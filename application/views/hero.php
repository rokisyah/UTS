	...
	<body>
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1>Daftar Hero <td> <?php foreach ($hero_list as $key) { ?><?php echo $key->keteranganJenis ?><?php } ?> </td></h1>
						<a href="<?php echo site_url('hero/create/'.$this->uri->segment(3)) ?>" type="button" class="btn btn-warning">Tambah Hero</a></li>
